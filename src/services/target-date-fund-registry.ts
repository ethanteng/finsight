...
const REGISTRY: RegistryEntry[] = [
  {
    ...
    sourceFingerprint: {
      ...
      value: 'd85de3641811e4c1c1d6d4bc8e69336ac09a80edac655a2ee99e22d483ca0bde',
      observedAt: '2026-08-22',
      sourceAsOf: '2026-06-30',
      observed: '2026-06-30|ssi us gov money market class=0.18|state street aggregate bond index portfolio=21.10|state street equity 500 index ii portfolio=19.56|state street global equity ex-u.s. index portfolio=13.68|state street small/mid cap equity index portfolio=2.45|state street spdr bloomberg 1-10 year tips etf=17.93|state street spdr bloomberg high yield bond etf=6.98|state street spdr dow jones global real estate etf=4.91|state street spdr portfolio short term corporate bond etf=1.99|state street spdr portfolio short term treasury etf=7.76|street spdr bloomberg enhanced roll yield commodity strategy no k-1 etf=3.51',
    },
  ...
  },
  {
    ...
    sourceFingerprint: {
      kind: 'published-values',
      value: 'd7490f54535b6d8962ba6f915af0eb3494e169add818264b2b16f4b710007c32',
      observedAt: '2026-08-22',
      sourceAsOf: '2026-06-30',
      observed: '2026-06-30|ssi us gov money market class=0.25|state street aggregate bond index portfolio=19.78|state street equity 500 index ii portfolio=27.38|state street global equity ex-u.s. index portfolio=21.01|state street small/mid cap equity index portfolio=4.07|state street spdr bloomberg 1-10 year tips etf=12.07|state street spdr bloomberg high yield bond etf=6.47|state street spdr dow jones global real estate etf=3.18|state street spdr portfolio long term treasury etf=3.44|state street spdr portfolio short term corporate bond etf=0.32|state street spdr portfolio short term treasury etf=1.09|street spdr bloomberg enhanced roll yield commodity strategy no k-1 etf=1.05',
    },
