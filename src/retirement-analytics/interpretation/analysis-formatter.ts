...
export function formatAnalysisOutput(
  ...
  return {
    ...
    metrics: {
      ...
      expenseRatioCoverage: portfolioMetrics.expenseRatioCoverage,
      countryAllocation: portfolioMetrics.countryAllocation,
      sectorAllocation: portfolioMetrics.sectorAllocation,
      countryCoverage: portfolioMetrics.countryCoverage,
      sectorCoverage: portfolioMetrics.sectorCoverage,
