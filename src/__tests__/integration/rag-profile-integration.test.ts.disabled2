...
import { getDataOrchestrator } from '../../data/orchestrator';
import { UserTier } from '../../data/types';

// Mock the data orchestrator
jest.mock('../../data/orchestrator', () => ({
  getDataOrchestrator: jest.fn(),
  dataOrchestrator: {
...
const MockGetDataOrchestrator = getDataOrchestrator as jest.MockedFunction<typeof getDataOrchestrator>;
    ...
    testCases.forEach(testCase => {
      it(`should handle RAG access correctly for ${testCase.name}`, async () => {
        ...
        if (testCase.tier === 'standard' || testCase.tier === 'premium') {
          mockOrchestrator.getSearchContext.mockResolvedValue({
          ...
          mockOrchestrator.getSearchContext.mockResolvedValue(null);
        }

        // Mock the getDataOrchestrator function to return our mock instance
        MockGetDataOrchestrator.mockReturnValue(mockOrchestrator as any);
