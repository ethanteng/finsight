...
describe('OpenAI Integration (Simple)', () => {
    ...
    describe('askOpenAI function', () => {
        it('should handle basic questions', () => __awaiter(void 0, void 0, void 0, function* () {
            mockAskOpenAI.mockResolvedValue('Your current balance is $1,500');
            const question = 'What is my current balance?';
            const conversationHistory = [];
            const response = yield mockAskOpenAI(question, conversationHistory);
            expect(response).toBe('Your current balance is $1,500');
            expect(mockAskOpenAI).toHaveBeenCalledWith(question, conversationHistory);
        }));
        it('should handle questions with conversation history', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should handle different user tiers', () => __awaiter(void 0, void 0, void 0, function* () {
            mockAskOpenAI.mockResolvedValue('Response based on tier');
            const question = 'What is my current balance?';
            const conversationHistory = [];
            // Test STARTER tier
            yield mockAskOpenAI(question, conversationHistory, types_1.UserTier.STARTER);
            expect(mockAskOpenAI).toHaveBeenCalledWith(question, conversationHistory, types_1.UserTier.STARTER);
            // Test STANDARD tier
            yield mockAskOpenAI(question, conversationHistory, types_1.UserTier.STANDARD);
            expect(mockAskOpenAI).toHaveBeenCalledWith(question, conversationHistory, types_1.UserTier.STANDARD);
            // Test PREMIUM tier
            yield mockAskOpenAI(question, conversationHistory, types_1.UserTier.PREMIUM);
            expect(mockAskOpenAI).toHaveBeenCalledWith(question, conversationHistory, types_1.UserTier.PREMIUM);
        }));
        it('should handle empty conversation history', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should handle API errors gracefully', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const question = 'What is my current balance?';
            const conversationHistory = [];
            yield expect(mockAskOpenAI(question, conversationHistory)).rejects.toThrow('OpenAI API error');
        }));
    });
    describe('Question Types', () => {
        it('should handle balance questions', () => __awaiter(void 0, void 0, void 0, function* () {
            mockAskOpenAI.mockResolvedValue('Your balance is $1,000');
            const questions = [
            ...
            for (const question of questions) {
                yield mockAskOpenAI(question, []);
                expect(mockAskOpenAI).toHaveBeenCalledWith(question, []);
            }
        }));
        it('should handle transaction questions', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should handle financial analysis questions', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should handle spending analysis questions', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('Response Quality', () => {
        it('should maintain conversation context', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const question = 'What is my net worth?';
            yield mockAskOpenAI(question, conversationHistory);
            expect(mockAskOpenAI).toHaveBeenCalledWith(question, conversationHistory);
        }));
        it('should handle follow-up questions', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('Tier-Based Features', () => {
        it('should provide different responses based on tier', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const conversationHistory = [];
            // Test STARTER tier
            const starterResponse = yield mockAskOpenAI(question, conversationHistory, types_1.UserTier.STARTER);
            expect(starterResponse).toBe('Basic response for Starter tier');
            // Test STANDARD tier
            const standardResponse = yield mockAskOpenAI(question, conversationHistory, types_1.UserTier.STANDARD);
            expect(standardResponse).toBe('Enhanced response with economic indicators for Standard tier');
            // Test PREMIUM tier
            const premiumResponse = yield mockAskOpenAI(question, conversationHistory, types_1.UserTier.PREMIUM);
