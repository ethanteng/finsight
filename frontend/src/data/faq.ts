...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "You can see a real answer free in the interactive demo with sample data — no card required. Ask Linc itself is $9/month for full access with your own accounts. We've found it works best when people use it with real questions from day one.",
  },
  {
