...
exports.getDemoDataAnalysis = exports.demoData = void 0;
...
const getDemoDataAnalysis = () => {
    const accounts = exports.demoData.accounts;
    const transactions = exports.demoData.transactions;
    const goals = exports.demoData.goals;
    ...
    const goalProgress = goals.map(goal => (Object.assign(Object.assign({}, goal), { progress: (goal.current / goal.target) * 100, remaining: goal.target - goal.current })));
    return {
        monthlyIncome,
        monthlyExpenses,
        monthlySavings,
...
exports.getDemoDataAnalysis = getDemoDataAnalysis;
