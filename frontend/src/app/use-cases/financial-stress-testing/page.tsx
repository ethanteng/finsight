...
export const metadata: Metadata = buildMarketingMetadata({
  ...
  description: 'Stress-test your retirement plan against market drops, inflation, spending changes, and different retirement dates using your own finances and historical returns.',
