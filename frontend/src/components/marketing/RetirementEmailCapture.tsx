 ...
 * a link that lands on signup with this address already filled in, so the only
 * thing left to choose is a password — and once that is done the run becomes
 * the first decision in the new account. See `docs/RETIREMENT_QUICKPLAN.md`.
 *
    ...
    <form className="qp-email-capture" onSubmit={handleSubmit} aria-busy={status === "sending"}>
      <div className="qp-email-copy">
        ...
        <p className="qp-email-lead">
          We will email you a link. Pick a password and this run is waiting for you as your first
