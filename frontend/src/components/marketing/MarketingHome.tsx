...
export default function MarketingHome({ pricing = FALLBACK_PRICING }: { pricing?: Pricing }) {
  return (
    <main className="marketing-site story-home">
      ...
      <section className="story-closing shell" id="pricing" aria-labelledby="start-title"><p className="section-kicker">START WITH YOUR QUESTION</p><h2 id="start-title">Your next move<br /><em>starts here.</em></h2><p>30 days free. Then {pricing.label}.<br />One plan. Full access. Cancel anytime.</p><MarketingGetStartedButton className="button button-primary" trackingLocation="homepage_final" csOverrideId="cta-start-free-trial-pricing-premium" /><small>{TRIAL_CTA_MICROCOPY}</small></section>
      <SiteFooter />
    </main>
  );
}
