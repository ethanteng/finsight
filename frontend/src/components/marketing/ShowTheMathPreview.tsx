...
export function ShowTheMathPreview() {
  return (
    <article className="trust-audit-card comparison-math-preview" aria-label="Illustrative Show the Math overview">
      ...
      <div className="trust-audit-verdict"><span aria-hidden="true">✓</span><div><small>LINC’S ANSWER</small><strong>Yes—if you keep enough cash after closing and leave retirement contributions unchanged.</strong></div></div>
