  ...
  return (
    <figure className="planning-flow" aria-label="Connect, ask, Linc does the work, explore your plan">
      <ol>
        ...
        <li className="flow-work"><span className="flow-step">03 / LINC DOES THE WORK</span><div className="flow-work-mark"><span className="brand-mark" aria-hidden="true">L</span><span className="flow-work-lines"><span><Check size={14} aria-hidden="true" /> Pulls it together</span><span><Check size={14} aria-hidden="true" /> Runs the numbers</span><span><Check size={14} aria-hidden="true" /> Tests the what-ifs</span></span></div><strong className="flow-caption">The analysis, handled.</strong><ArrowRight className="flow-arrow" aria-hidden="true" /></li>
      ...
      <figcaption>One question. The whole picture. <Link href="/demo" data-cs-override-id="homepage-full-product-demo">Explore the full demo <span aria-hidden="true">↗</span></Link></figcaption>
    </figure>
  );
}
