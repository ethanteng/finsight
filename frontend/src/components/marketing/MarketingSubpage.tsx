...
function LegalPage({ type }: { type: "privacy" | "terms" }) {
  ...
  const sections = privacy ? [
    ...
    ["6. Service providers", "Ask Linc uses service providers for account connections, AI analysis, payments, hosting, and privacy-conscious analytics. These include Plaid, SnapTrade, Anthropic, Google, Stripe, Render, and Vercel."],
