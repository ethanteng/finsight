    ...
    <>
      ...
      <section className="shell cf-guides" aria-labelledby="coast-fire-guides-title">
        <div>
          ...
          <h2 id="coast-fire-guides-title">More about Coast FIRE.</h2>
        </div>
        <ul>
          ...
          <li><Link href="/blog/coast-fire-vs-fire-vs-barista-fire"><strong>Coast FIRE vs FIRE vs Barista FIRE</strong><span>Compare how much each approach relies on work income and investments.</span></Link></li>
