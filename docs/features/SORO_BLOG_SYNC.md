...
card, and `MarketingArticlePage` renders it in the article header. Both retain
the branded artwork as a fallback. A failed upload falls back to the Soro URL
